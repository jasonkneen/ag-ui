...
- `PROTOCOL_VERSION` now reads "1.0" instead of "draft"; generated headers name the 1.0 schema address.
...
- Protocol version constant value changed from "draft" to "1.0".
