...
export default function getEnvVars(): envVars {
  ...
  return {
    ...
    claudeAgentSdkPythonUrl: process.env.CLAUDE_AGENT_SDK_PYTHON_URL || 'http://localhost:8888',
    claudeAgentSdkTypescriptUrl: process.env.CLAUDE_AGENT_SDK_TYPESCRIPT_URL || 'http://localhost:8889',
